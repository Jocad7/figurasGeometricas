...
//suma con reduce(), alternativa para el ciclo For(i=0; i ; i++)
// var lista = [400,200,300,500];
...
// var pokemons = ["Pikachu", "charizard", "Venusaur", "Blastoise"];
// const equipoPokemon = pokemons.reduce(function(Anterior,actual)
//     {
//     return `${Anterior} ${actual},`;}, "Mi equipo pokemon es: ");
